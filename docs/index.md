---
layout: default
title: CakePHP 5.x Documentation
...
<div style="padding: 15px; border-left: 4px solid #28a745; background: var(--bg-secondary);">
  <strong>✅ GitHub Pages Compatible</strong><br>
  Renders perfectly on GitHub Pages
</div>

<div style="padding: 15px; border-left: 4px solid #007bff; background: var(--bg-secondary);">
  <strong>📊 Mermaid Diagrams</strong><br>
  Enhanced with visual flowcharts
</div>

<div style="padding: 15px; border-left: 4px solid #ffc107; background: var(--bg-secondary);">
  <strong>💻 Code Examples</strong><br>
  Complete, working code examples
</div>

<div style="padding: 15px; border-left: 4px solid #6f42c1; background: var(--bg-secondary);">
  <strong>🌙 Dark Mode</strong><br>
  Toggle between light and dark themes
</div>

<div style="padding: 15px; border-left: 4px solid #dc3545; background: var(--bg-secondary);">
  <strong>📋 Copy Buttons</strong><br>
  One-click code copying
</div>

<div style="padding: 15px; border-left: 4px solid #17a2b8; background: var(--bg-secondary);">
...
<div style="text-align: center; margin: 40px 0; padding: 30px; background: var(--bg-secondary); border-radius: 8px;">
